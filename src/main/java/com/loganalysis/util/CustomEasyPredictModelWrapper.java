...
public class CustomEasyPredictModelWrapper implements java.io.Serializable {
     ...
     */
    public CustomEasyPredictModelWrapper(Config config) {
        m = config.getModel();
     ...
     */
    public CustomEasyPredictModelWrapper(GenModel model) {
        this(new Config()
                .setModel(model));
    }
    ...
    public AutoEncoderModelPrediction predictAutoEncoder(RowData data) throws PredictException {
        ...
        return new AutoEncoderModelPrediction();
